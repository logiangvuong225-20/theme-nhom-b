...
$less = new lessc;
$less->compileFile('less/md_7.less', 'css/md_7.css');
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <link href="<?php echo $url_path ?>/css/md_7.css" rel="stylesheet" type="text/css" />
    ...
    <body >
        <?php include '../theme-nhom-b/md_7-content.php'; ?>
    </body>
</html>